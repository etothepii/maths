...
def test_can_step_1():
    ...
    result = start.step()
    assert result == expected, "Even, Odd"
...
def test_can_step_2():
    ...
    result = start.step()
    assert result == expected, "Even, Even"
...
def test_can_step_3():
    ...
    result = start.step()
    assert result == expected, "Odd, Even"
...
def test_can_step_4():
    ...
    result = start.step()
    assert result == expected, "Odd, Odd"
...
def test_can_terminate():
    ...
    expected = set()
    result = start.step()
    assert result == expected, "Can Terminate"
